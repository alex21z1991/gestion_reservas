...
class Negocio(models.Model):
    ...
    imagen_miniatura = models.ImageField(upload_to='negocios/miniaturas/', null=True, blank=True)
    imagen_hero = models.ImageField(upload_to='negocios/heroes/', null=True, blank=True)
